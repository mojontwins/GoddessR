...
// UNROM version (just added a CHR-RAM pattern data decompressor by tokumaru)
...
// Inits famitone (no longer automatic)
...
void __fastcall__ tkrom_bankswitch (unsigned char reg, unsigned char val);
