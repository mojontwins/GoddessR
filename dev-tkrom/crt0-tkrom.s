...
; Extended for my TKROM needs: this crt0 makes sure 
; Switchable 8K + Switchable 8K + Fixed 16K configuration is used
; So PRG second-to-last is sitting at $c000.
; the "Main" page for cc65 and neslib from now on will be a 16K
; one sitting at $c000 and composed by PRGs second-to-last and last.
; Confusing? Well, tell me!

NES_MAPPER				=4			;mapper number
NES_PRG_BANKS			=16			;number of 16K PRG banks, change to 2 for NROM256
NES_CHR_BANKS			=16			;number of 8K CHR banks
...
@1:
	...
	lda #<(__RAM_START__+__RAM_SIZE__-2)
	sta sp
	lda #>(__RAM_START__+__RAM_SIZE__-2)
