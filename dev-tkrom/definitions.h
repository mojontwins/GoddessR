...
// Banks and slots
	...
	#define FG_BANK_01					0x80
	#define FG_BANK_23					0x81
	#define BG_BANK_0 					0x82
	#define BG_BANK_1					0x83
	#define BG_BANK_2					0x84
	#define BG_BANK_3					0x85

	#define CHR_BANK_TS_GAME			0
	#define CHR_BANK_TS_ANIM 			4
	#define CHR_BANK_MAP 				8
	#define CHR_BANK_FONT 				9
	#define CHR_BANK_CUTS1				10
	#define CHR_BANK_CUTS2 				12
	#define CHR_BANK_TITLE 				14
	#define CHR_BANK_ENDING 			16
	#define CHR_BANK_SPRITESET 			18

	#define PRG_BANK_A_SCROLL			0
	#define PRG_BANK_B_SCROLL			1
	#define PRG_BANK_A_RLE_SCREENS 		3
	#define PRG_BANK_A_MAIN_DATA		4
	#define PRG_BANK_B_MAIN 			6
	#define PRG_BANK_B_ENEMS 			7
