...
;Feel free to do anything you want with this code, consider it Public Domain
	...
	; TKROM
	.export _tkrom_bankswitch, _tkrom_set_mirroring
...
; void __fastcall__ bankswitch (unsigned char bank, unsigned char value);
_tkrom_bankswitch:
	tax			; X -> value
	jsr popa 	; A -> bank
	cmp #$86
	bne bankswitch_no_save
	; Only save current bank when paging $8000 (REG 6)
	stx CURRENT_BANK
bankswitch_no_save:
	; here, A -> bank, X -> value
	sta $8000
...
; void __fastcall__ tkrom_set_mirroring (unsigned char m);
_tkrom_set_mirroring:
	and #$1
	sta $A000
	rts
